...
from keras.layers import AveragePooling2D, Dense, Flatten, Conv2D, MaxPooling2D, BatchNormalization
...
def main(args):
    ...
    model = Sequential()
    model.add(Conv2D(64, (10, 10), strides=(3,3), padding='valid',
    ...
    X_train, y_train, X_val, y_val = augment(X_train,
        y_train, X_val, y_val, ['classification'],
